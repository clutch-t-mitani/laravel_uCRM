...
const deleteItem = item => {
    Inertia.delete(route('items.destroy', {item: item}), {
                            ...
                            <div class="container px-5 py-8 mx-auto">
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <Link as="button" :href="route('items.edit', { item: item })"class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                                                編集する
                                            </Link>
                                        </div>

                                        <div class="p-2 w-full mt-20">
                                            <button @click="deleteItem(item)" class="flex mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">
                                                削除する
                                            </button>
                                        </div>
                                    </div>
