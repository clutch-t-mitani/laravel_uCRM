                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <!-- テーブル -->
                                            <table class="table-auto w-full text-left whitespace-no-wrap my-4">
                                                <thead>
                                                    <tr>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div type="date" id="date" name="date" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                        {{ props.order[0].status ? '未キャンセル' : 'キャンセル済' }}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div type="date" id="date" name="date" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                        {{ !props.order[0].status ? dayjs(props.order[0].updated_at).format('YYYY/MM/DD') : '--' }}
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="p-2 w-full" v-if="props.order[0].status">
                                                <Link as="button" :href="route('purchases.edit', { purchase: props.order[0] })"class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                                                編集する
                                                </Link>
                                            </div>
                                        </div>
