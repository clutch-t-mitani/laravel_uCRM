                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input disabled ="date" id="date" name="date" :value="form.date" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input disabled ="date" id="customer" name="customer" :value="props.order[0].customer_name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label class="leading-7 text-sm text-gray-600 mr-2">ステータス</label><br>
                                                <input type="radio" id="status_true" name="status" value="1" v-model="form.status" class="mr-1">
                                                <label class="leading-7 text-sm text-gray-600 mr-2" for="status_true">未キャンセル</label>
                                                <input type="radio" id="status_false" name="status" value="0" v-model="form.status" class="mr-1">
                                                <label class="leading-7 text-sm text-gray-600" for="status_false">キャンセルする</label>
                                            </div>
                                        </div>
