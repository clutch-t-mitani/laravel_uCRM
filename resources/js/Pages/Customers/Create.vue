...
defineProps({
    errors: Object // laravelでバリデーションすればエラーが返ってくる
})
                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input @change="fetchAddress" type="number" id="postcode" name="postcode" v-model="form.postcode" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <label class="ml-2 mr-4" for="gender1">男性</label>

                                                    <input type="radio" id="gender2" name="gender" v-model="form.gender" value="1" class="ml-2"/>
                                                    <label class="ml-2 mr-4" for="gender2">女性</label>

                                                    <input type="radio" id="gender3" name="gender" v-model="form.gender" value="2" class="ml-2"/>
                                                    <label class="ml-2 mr-4" for="gender3">その他</label>
